...
ADMIN_TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "admin_web.bot_setting.value.description": "For group_invite_share_template, keep {link}; the bot replaces it with the generated invite link.",
    ...
    "zh": {
        ...
        "admin_web.bot_setting.value.description": "邀请文案模板请保留 {link}，机器人会替换为系统生成的专属邀请链接。",
