...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "payments.success_suffix.tg": "Stripe / Card",
        ...
        "payments.invoice.desc.topup.fiat": "Оплата банковской картой через Stripe в Telegram",
    ...
    "en": {
        ...
        "payments.invoice.desc.topup.fiat": "Pay by card via Stripe inside Telegram",
...
ZH_OVERRIDES = {
    ...
    "payments.invoice.desc.topup.fiat": "通过 Telegram 内的 Stripe 卡支付",
